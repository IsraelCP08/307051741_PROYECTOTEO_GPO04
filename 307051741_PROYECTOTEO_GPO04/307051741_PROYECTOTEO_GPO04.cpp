...
int main()
{
    ...
    Model tina((char*)"Models/bañera/tina.obj");
    Model pisob((char*)"Models/pisobaño/pisob.obj");
    Model tapete((char*)"Models/tapete/tapete.obj");
    Model mueble((char*)"Models/mueblebaño/mueble.obj");
    Model bancob((char*)"Models/bancob/banco.obj");
    Model sofac((char*)"Models/sofacama/sofa.obj");
    Model lavabo((char*)"Models/lavabo/lavabo.obj");
    Model llavela((char*)"Models/llavelava/llave.obj");
    Model crema((char*)"Models/crema/crema.obj");
    Model espejo((char*)"Models/espejo/espejo.obj");
    Model toallero((char*)"Models/toallero/toallero.obj");
    Model llaveba((char*)"Models/llavelava/llaveb.obj");
    Model pared((char*)"Models/paredsala/pared.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // modelo cuadro rojo
        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(4.5f, 2.0f, 5.65f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        cuadro1.Draw(shader);
        // modelo cuadro gris
        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(6.85f, 2.0f, 1.9f));
        ...
        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(6.225f, 0.211f, -6.87f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        tina.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(1.73f, 0.213f, -6.57f ));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        tapete.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(1.601f, 0.559f, -7.851f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        mueble.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(5.949f, 0.213f, -4.934f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        bancob.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(1.756f, 0.241f, -4.768f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        sofac.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(2.382f, 1.287f, -7.819f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        lavabo.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(2.279f, 1.519f, -8.025f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        llavela.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(0.949f, 1.11f, -7.921f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        crema.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(2.326f, 1.717f, -8.154f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        espejo.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(3.784f, 1.518f, -7.902f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        toallero.Draw(shader);

        model = glm::mat4(1);
        model = glm::translate(model, glm::vec3(6.547f, 1.098f, -6.914f));
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        llaveba.Draw(shader);
